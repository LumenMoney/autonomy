So! First we have to increase allowance on the CW20 token which we want to transfer to the contract. Following is an example where the contract address is. 
